...
p <- ggplot(amznStockg, aes(monthweek, weekdayf, fill = amznStockg$freq)) + 
    geom_tile(colour = "white") + facet_grid(year(amznStockg$time)~monthf) + scale_fill_gradient(low="red", high="green") +  xlab("Week of Month") + ylab("") + ggtitle("Time-Series Calendar Heatmap: Social media Recruitment") + labs(fill = "# Recruited")
...
f <- ggplot(amznStockg, aes(monthweek, weekdayf, fill = amznStockg$freq)) + 
    geom_tile(colour = "white") + facet_grid(year(amznStockg$time)~monthf) + scale_fill_gradient(low="red", high="green") +  xlab("Week of Month") + ylab("") + ggtitle("Time-Series Calendar Heatmap: Flyer Recruitment") + labs(fill = "# Recruited")
...
w <- ggplot(amznStockg, aes(monthweek, weekdayf, fill = amznStockg$freq)) + 
    geom_tile(colour = "white") + facet_grid(year(amznStockg$time)~monthf) + scale_fill_gradient(low="red", high="green") +  xlab("Week of Month") + ylab("") + ggtitle("Time-Series Calendar Heatmap: Word-of-mouth Recruitment") + labs(fill = "# Recruited")
