...
record_id <- "BLS001A"  #***Replace with the target record ID
...
names(txt_file)[names(txt_file) == "Measure"] <- "food_measure_quantity"
...
redcap_ready=dietrecord2redcap(txt_file,event_name_short)
