...
#merge different BMI numbers into one column to fill in N/A blanks
...
save(list=c("Eligible_Pass_age_bmi_clean","CP_age_bmi_clean"),file="~/BEACH-Reports/output/reports/recruitment/Current_Particpant_clean.RData")
