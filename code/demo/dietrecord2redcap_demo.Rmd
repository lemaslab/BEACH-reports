...
# import CSV
data_wide <- read_csv("C:/Users/djlemas/Dropbox (UFL)/02_Projects/BEACH_STUDY/10_Diet/BLS030A_Third_Trimester_example.csv") %>% as_tibble()

# # import data
# data_wide=read_excel("C:/Users/djlemas/Dropbox (UFL)/02_Projects/BEACH_STUDY/10_Diet/BLS030A_Third_Trimester_example.xlsx", sheet = "sheet1") %>% as.data.frame
...
redcap_event_name="third_trimester_arm_1"

dietrecord2redcap <- function(diet_wide, redcap_event_name) {
            data_wide_rename=diet_wide %>%
                rename( wgt_g="Wgt (g)",
                        cals_kcal="Cals (kcal)",
...
data_long=gather(data_wide_rename, key="food_record_nutrient", value="food_record_value", wgt_g:chln_mg) %>%
...
demo=dietrecord2redcap(data_wide,"third_trimester_arm_1")
...
write_csv(data_long,"C:/Users/djlemas/Dropbox (UFL)/02_Projects/BEACH_STUDY/10_Diet/BLS030A_Third_Trimester_redcap_ready.csv" )
