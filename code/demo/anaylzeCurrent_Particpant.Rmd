...
```{r, message=FALSE,warning=FALSE, echo = FALSE}
vtree(Phone_Screen_age_bmi, "Phone_Screen Random_Contact Age_grouping", palette = 3, sortfill = TRUE, horiz=FALSE)
```

```{r, message=FALSE,warning=FALSE, echo = FALSE}
vtree(Phone_Screen_age_bmi, "Consent", palette = 3, sortfill = TRUE, horiz=FALSE)
```
...
#Consent
```{r, message=FALSE,warning=FALSE, echo = FALSE}
CP_Consent= filter(Phone_Screen_age_bmi, Consent == "Yes")
```

```{r, message=FALSE,warning=FALSE, echo = FALSE}
vtree(CP_Consent, "BMI_Type Recruitment", palette = 3, sortfill = TRUE, horiz=FALSE)
```
