...
data <- data.frame(barplot_consent,barplot_eligible)
names(data)[1] <- "Recruitment Type"
names(data)[2] <- "Consent"
names(data)[4] <- "Eligible"
data <- data[ -c(3) ]
...
barplot(main = "Recruitment", data1,beside=TRUE, col = c("blue","orange"), ylab = "Participants", ylim = c(0,60), xlab = "Recruitment Type", legend.text = TRUE)
