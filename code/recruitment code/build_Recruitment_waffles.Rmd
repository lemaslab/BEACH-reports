...
barplot(BMI_bar1, beside = TRUE, ylab = "Participants", legend.text = TRUE)
...
sum(BMI_all$month == 'Jan' | BMI_all$month == 'Feb' | BMI_all$month == 'Mar')
sum(BMI_all$month == 'Apr' | BMI_all$month == 'May' | BMI_all$month == 'Jun')
sum(BMI_all$month == 'Jul' | BMI_all$month == 'Aug' | BMI_all$month == 'Sep')
sum(BMI_all$month == 'Oct' | BMI_all$month == 'Nov' | BMI_all$month == 'Dec')
