---
title: "format_Recruitment_BMI_Type"
...
#Overweight +Obese
```{r, message=FALSE,warning=FALSE, echo = FALSE}
Phone_Screen_age_bmi$BMI[Phone_Screen_age_bmi$BMI_Type=="Obese"] <- "Obese"
Phone_Screen_age_bmi$BMI[Phone_Screen_age_bmi$BMI_Type=="Overweight"] <- "Overweight"
...
```{r, message=FALSE,warning=FALSE, echo = FALSE}
Phone_Screen_age_bmi$Outcomes[Phone_Screen_age_bmi$beachphone_pass_fail=="Fail"] <- "Screened but not Eligible"
Phone_Screen_age_bmi$Outcomes[Phone_Screen_age_bmi$beachphone_pass_fail=="Pass" & Phone_Screen_age_bmi$Consent=="No"] <- "Eligible but not consented"
Phone_Screen_age_bmi$Outcomes[Phone_Screen_age_bmi$Consent=="Yes" & Phone_Screen_age_bmi$Complete=="No"] <- "Consented not completed"
Phone_Screen_age_bmi$Outcomes[Phone_Screen_age_bmi$Complete=="Yes"] <- "Completed"
