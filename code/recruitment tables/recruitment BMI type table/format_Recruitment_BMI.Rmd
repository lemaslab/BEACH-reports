...
Phone_Screen_age_bmi=Phone_Screen %>%
  select(test_id,
   ...
   mutate(Bmi_grouping = case_when((prepreg_bmi >= 29) ~ "Obese",
                                  ...
                                  (prepreg_bmi >= 18.5 & prepreg_bmi<26) ~ "Normal",
...
Phone_Screen_age_bmi$Outcomes[Phone_Screen_age_bmi$Consent=="Yes" & Phone_Screen_age_bmi$Complete=="No"] <- "Consented but completed"
