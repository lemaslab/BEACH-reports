...
#Overweight +Obese
```{r, message=FALSE,warning=FALSE, echo = FALSE}
Part_Dem_age_bmi$BMI[Part_Dem_age_bmi$BMI_Type=="Obese"] <- "Obese"
Part_Dem_age_bmi$BMI[Part_Dem_age_bmi$BMI_Type=="Overweight"] <- "Overweight"
