---
title: "Demographics of participant recruitment that were screened for eligibility over time - part 1"
...
mod_vtree <- Just_Phone_Screen_Dem
mod_vtree$`Age_grouping`[is.na(mod_vtree$`Age_grouping`)] <- "Missing"
vtree(mod_vtree, "Phone_Screen Age_grouping", palette = 3, sortfill = TRUE, horiz = FALSE, showpct = TRUE)

#vtree(Just_Phone_Screen_Dem, "Phone_Screen Age_grouping", palette = 3, sortfill = TRUE, horiz=FALSE, showpct = TRUE)
```
...
#change NA to missing so it is accounted for in vtree
mod_vtree <- Just_Phone_Screen_Dem
mod_vtree$`BMI`[is.na(mod_vtree$`BMI`)] <- "Missing"

vtree(mod_vtree, "Phone_Screen BMI", palette = 3, sortfill = TRUE, horiz = FALSE, showpct = TRUE)
...
#change NA to missing so it is accounted for in vtree
mod_vtree <- Combined_Dem
mod_vtree$`Age_grouping`[is.na(mod_vtree$`Age_grouping`)] <- "Missing"

vtree(mod_vtree, "Prescreen_Survey Phone_Screen Age_grouping", palette = 3, sortfill = TRUE, horiz = FALSE, showpct = TRUE)
