...
#create barplot
bar_heights <- barplot(data3, beside = TRUE, col = c("#F8766D", "#00BFC4", "#6A3D9A"), 
...
bar_heights <- barplot(data3, beside = TRUE, col = c("#F8766D", "#00BFC4", "#6A3D9A"), 
                       ylab = "Percent Consented", ylim = c(0, 150), 
