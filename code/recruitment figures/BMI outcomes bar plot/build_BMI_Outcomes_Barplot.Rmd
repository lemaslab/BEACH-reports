...
```{r, message=FALSE,warning=FALSE, echo = FALSE}
###barplot
barplot( data1,beside=TRUE, col = c("blue","orange"),xlab = "Recruitment Method" , ylab = "Participants", ylim = c(0,60), legend.text = TRUE)
...
```{r, message=FALSE,warning=FALSE, echo = FALSE}
###barplot
barplot( data3,beside=TRUE, col = c("steelblue","seagreen"), ylab = "Percent Consented", ylim = c(0,120), xlab = "Recruitment", legend.text = TRUE)
...
names(data)[5] <- "Complete OB"
names(data)[7] <- "Consent OB"
data <- data[ -c(3,6) ]
#changing column titles, cutting out extra recruitment type column
data <- as.data.frame(t(data))
names(data) <- data[1,]
...
```{r, message=FALSE,warning=FALSE, echo = FALSE}
###barplot
barplot( data3,beside=TRUE, col = c("coral","skyblue"), ylab = "Percent Completed", ylim = c(0,120), xlab = "Recruitment", legend.text = TRUE)
