...
bar_heights <- barplot( data3,beside=TRUE, col = c("blue","orange"), ylab = "Percentage", ylim = c(0,120), xlab = "Recruitment", legend.text = TRUE, cex.axis = 1.5, cex.lab = 1.5, cex.names = 1.5)
